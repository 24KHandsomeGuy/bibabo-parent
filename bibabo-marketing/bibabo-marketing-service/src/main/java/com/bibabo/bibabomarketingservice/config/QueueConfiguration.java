...
public class QueueConfiguration {
    ...
    public QueueWorker grantCouponQueueWorker() {
        QueueWorker queueWorker = new QueueWorker("grantCouponProcessRunner", RedisRateLimiterEnum.QUEUE_GRANT_COUPONS);
        return queueWorker;
    }
    ...
    public QueueWorker marketingActivityQueueWorker() {
        QueueWorker queueWorker = new QueueWorker("marketingActivityProcessRunner", RedisRateLimiterEnum.QUEUE_ACTIVITY);
        return queueWorker;
    }
